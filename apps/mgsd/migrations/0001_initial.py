# Generated by Django 2.0.12 on 2019-07-03 10:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('systempolicycentralizedmanagement_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='mgsd.SystemPolicyCentralizedManagement')),
            ...
            bases=('mgsd.systempolicycentralizedmanagement',),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='cop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cop_center', to='mgsd.SysManagerCopInfo', verbose_name='系统部件'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='objprocess',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sys_user_process', to='mgsd.ConnectManagerUserInfo', verbose_name='系统部件用户'),
        ),
        migrations.AddField(
            model_name='infosecevent',
            name='impact_cops',
            field=models.ManyToManyField(related_name='info_conn_cops', to='mgsd.SysManagerCopInfo', verbose_name='受影响的资产列表'),
        ),
        migrations.AddField(
            model_name='infosecevent',
            name='info_source',
            field=models.OneToOneField(default=None, on_delete=django.db.models.deletion.DO_NOTHING, related_name='info_source', to='mgsd.SysManagerCopInfo', verbose_name='信息来源'),
        ),
        migrations.AddField(
            model_name='infosecevent',
        ...
        migrations.AddField(
            model_name='auditlogobject',
            name='process',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cop_audit_process', to='mgsd.ObjProcess', verbose_name='审计对象进程指定'),
        ),
    ]
