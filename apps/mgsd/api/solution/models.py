...
class InfoSecEvent(models.Model):
    ...
    info_source = models.ForeignKey(SysManagerCopInfo, verbose_name="信息来源", related_name="info_source", on_delete=models.DO_NOTHING, blank=True)
    infosysname = models.CharField(max_length=200, verbose_name="事件名称", default="")
    extra = models.CharField(max_length=200, verbose_name="额外补充字段", default="")
