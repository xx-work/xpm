# Generated by Django 2.1.7 on 2019-06-11 10:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('opreate_username', models.CharField(max_length=33, verbose_name='平台操作者')),
                ('change_subject', models.CharField(blank=True, max_length=33, verbose_name='变更的主体')),
                ('change_object', models.CharField(blank=True, max_length=33, verbose_name='变更受体')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_protocal', models.CharField(choices=[('ssh', 'SSH'), ('http', 'HTTP'), ('https', 'HTTPS'), ('snmp', 'SNMP'), ('smb', 'SMB'), ('ftp', 'FTP'), ('smtp', 'SMTP')], default='ssh', max_length=32, verbose_name='管理的协议')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('had_action', models.TextField(blank=True, verbose_name='已经采取的行动')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('process_stat', models.CharField(choices=[('RUNING', 'RUNING'), ('STOPED', 'STOPED'), ('APPENDING', 'APPENDING')], max_length=55, verbose_name='进程名称')),
                ...
                ('date_create', models.DateTimeField(auto_now_add=True, verbose_name='发现时间')),
            ],
        ),
        migrations.CreateModel(
            name='PolicyAction',
            fields=[
                ...
                ('_connect_main', models.CharField(blank=True, max_length=256, verbose_name='关联的核心URL和请求方法')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('uniq_flag', models.CharField(max_length=32, unique=True, verbose_name='系统部件唯一标识')),
                ('sys_except_handle', models.CharField(default='WAF设备CYA-6000存在3条告警信息', max_length=32, verbose_name='异常处理的信息')),
                ('sys_stat', models.IntegerField(default=1, verbose_name='系统部件状态')),
        ...
        migrations.CreateModel(
            name='SystemObjProcess',
            fields=[
                ('objprocess_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='server.ObjProcess')),
                ('cop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sys_cop_process', to='server.SysManagerCopInfo', verbose_name='系统部件')),
                ('user', models.ManyToManyField(related_name='sys_user_process', to='server.ConnectManagerUserInfo', verbose_name='系统部件用户')),
            ],
            bases=('server.objprocess',),
        ),
        migrations.AddField(
            model_name='snmphostdata',
            name='cop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='snmp_data_of_cop', to='server.SysManagerCopInfo', verbose_name='平台中的系统部件'),
        ),
        migrations.AddField(
            model_name='snmpagentcfginfo',
            name='cop',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='snmp_cfg_of_cop', to='server.SysManagerCopInfo', verbose_name='平台中的系统部件'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='policyrule',
            name='policy_action',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='policy_rule_cop', to='server.PolicyAction', verbose_name='规则执行'),
        ),
        migrations.AddField(
            model_name='policyrule',
            name='policy_bench',
        ...
        migrations.AddField(
            ...
            name='belong_cop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='系统部件', to='server.SysManagerCopInfo'),
        ),
        migrations.AddField(
            model_name='policyaction',
            name='cop_user',
