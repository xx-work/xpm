...
from agent.minitord.snmpd.views import collect_data, snmp_urlparterns
urlpatterns += [
    url('collect_data_cso_snmp_v2', collect_data),     ## 生成令牌
]
urlpatterns += snmp_urlparterns
...
from agent.api.devices.views import agentapi_urlparterns
urlpatterns += agentapi_urlparterns