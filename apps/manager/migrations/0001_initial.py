# Generated by Django 2.0.12 on 2019-06-25 09:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('policyaction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='action_policy_history', to='manager.PolicyAction')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('process', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='process_audit', to='manager.ObjProcess', verbose_name='进程监控')),
            ],
            options={
                'verbose_name': '进程监控周期',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('managers', models.ManyToManyField(blank=True, related_name='sys_cop_conn_users', to='manager.ConnectManagerUserInfo', verbose_name='系统部件管理用户')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sys_stat', models.CharField(choices=[('RUNING', '运行中'), ('STOPED', '已停止'), ('APPENDING', '监控中')], default='RUNING', max_length=33, verbose_name='系统部件状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('systempolicycentralizedmanagement_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='manager.SystemPolicyCentralizedManagement')),
            ...
            bases=('manager.systempolicycentralizedmanagement',),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='cop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cop_center', to='manager.SysManagerCopInfo', verbose_name='系统部件'),
        ),
        migrations.AddField(
            model_name='policyrule',
            name='belong_cop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='policy_rule_cop', to='manager.SysManagerCopInfo', verbose_name='部件应用'),
        ),
        migrations.AddField(
            model_name='policyrule',
            name='policy_action',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='policy_rule_cop', to='manager.PolicyAction', verbose_name='规则执行指定'),
        ),
        migrations.AddField(
            model_name='policyrule',
            name='policy_bench',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='policy_bench_rule', to='manager.PolicyBench', verbose_name='策略基准'),
        ),
        migrations.AddField(
            model_name='policyaction',
            name='belong_cop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cop_policy_conn', to='manager.SysManagerCopInfo', verbose_name='部件应用'),
        ),
        migrations.AddField(
            model_name='policyaction',
            name='cop_user',
            field=models.ManyToManyField(blank=True, related_name='policy_action_users', to='manager.ConnectManagerUserInfo', verbose_name='关联的部件用户'),
        ),
        migrations.AddField(
            model_name='objprocess',
            name='cop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sys_cop_process', to='manager.SysManagerCopInfo', verbose_name='系统部件'),
        ),
        migrations.AddField(
            model_name='objprocess',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sys_user_process', to='manager.ConnectManagerUserInfo', verbose_name='系统部件用户'),
        ),
        migrations.AddField(
            model_name='infosecevent',
            name='impact_cops',
            field=models.ManyToManyField(related_name='info_conn_cops', to='manager.SysManagerCopInfo', verbose_name='受影响的资产列表'),
        ),
        migrations.AddField(
            model_name='infosecevent',
            name='info_source',
            field=models.OneToOneField(default=None, on_delete=django.db.models.deletion.DO_NOTHING, related_name='info_source', to='manager.SysManagerCopInfo', verbose_name='信息来源'),
        ),
        migrations.AddField(
            model_name='infosecevent',
            name='negative_impacts',
            field=models.ManyToManyField(related_name='info_conn_attack', to='manager.AttackerActionDesc', verbose_name='攻击者行为描述'),
        ),
        migrations.AddField(
            model_name='infogoin',
            name='info',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='info_going', to='manager.InfoSecEvent', verbose_name='事件'),
        ),
        migrations.AddField(
            model_name='auditlogobject',
            name='cop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cop_to_audit', to='manager.SysManagerCopInfo', verbose_name='审计对象部件'),
        ),
        migrations.AddField(
            model_name='auditlogobject',
            name='process',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cop_audit_process', to='manager.ObjProcess', verbose_name='审计对象进程指定'),
        ),
    ]
